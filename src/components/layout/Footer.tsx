                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                    ...
                    >
                        <Link to={APP_CONFIG.routes.home} className="flex items-center">
                            <div className="mr-2">
                                <img alt={"logo"} src={logo} width={155} height={155}/>
                        ...
                        <div className="mt-6">
                            <div className="flex space-x-4">
                                ...
                                <a href="https://github.com/Tiger-Foxx/" className="text-gray-400 hover:text-white transition-colors duration-300">
                                ...
                                <a href="https://www.youtube.com/@tigerfoxproduction8907" className="text-gray-400 hover:text-white transition-colors duration-300">
